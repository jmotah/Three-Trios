...
public class PlusBattleRule implements BattleRules {
   ...
   *     flipped
   */
  private List<Point> determineGreatestNumberOfPointsWithSameSum(int row, int column, Grid[][]
          grid) {
    HashMap<Point, Integer> cellsAndDirectionalSums = getAdjacentCellsWithDirectionalSum(
            row, column, grid);
   ...
   */
  private List<Point> findPointsWithSameSum(HashMap<Point, Integer> cellsAndDirectionalSums,
                                            int sum) {
