...
public class MainPlayerColorToProviderPlayerColor implements ConvertEnums<PlayerColor> {
  ...
  public MainPlayerColorToProviderPlayerColor(cs3500.threetrios.providers.model.PlayerColor color) {
    this.color = color;
  }
  ...
  private PlayerColor mainColorToProvidedPlayerColor(
          cs3500.threetrios.providers.model.PlayerColor mainColor) {
    switch (mainColor) {
      case RED:
