...
//    int highestScore = 0;
//    Point highestScorePosition = null;
//    java.util.List<Point> keys = getAllPossibleMoves();
//
...
//    java.util.List<PlayingCard> hand = playerModel.getCurrentTurnPlayer().getHand();
...
//   * tile on a grid.
//   */
//  private java.util.List<Point> getAllPossibleMoves() {
