...
/**
 * Represents tests for the verifying the ReverseFallenAce battle strategy works as expected. This
 * is all done alongside the Normal battle rule.
 */
public class ReverseFallenAceBattleStrategyTest {
  ...
  public void testValidBattleWithCombo() {
    ...
    Assert.assertEquals(expectedTileColor,
            model.getGrid()[2][1].getWhichPlayersTile().getPlayersColor());
    Assert.assertEquals(expectedTileColor,
            model.getGrid()[1][1].getWhichPlayersTile().getPlayersColor());
  }
