...
/**
 * Represents tests for the verifying the Reverse battle strategy works as expected. This is
 * all done alongside the Normal battle rule.
 */
public class ReverseBattleStrategyTest {
  ...
  @Test
  public void testInvalidBattleGreaterThan() {
    model.playToGrid(1, 1, 0);
    model.battle(1, 1);
