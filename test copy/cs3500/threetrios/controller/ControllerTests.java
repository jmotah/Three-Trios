...
public class ControllerTests {
  ...
  @Test
  public void testHintsToggled() {
    Players redPlayer = model.getCurrentTurnPlayer();
    ThreeTriosView redView = new GraphicalView(model);

    final boolean[] hintsToggled = {false};
    HintsToggleListener mock = new HintsToggleListener() {
    ...
    redView.setHintsToggleListener(mock);
    mock.hintsToggled();
    Assert.assertTrue(hintsToggled[0]);
  }
}